        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-2 reveal">
            ...
            <div className="flex flex-col gap-6 mb-10">
              {[
                { icon: "📞", label: "Phone / Text", value: "703-957-8309", href: "tel:7039578309" },
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <a href="tel:7039578309" className="text-white/75 hover:text-brass transition-colors font-body" style={{ fontSize: "0.875rem" }}>
                  703-957-8309
                </a>
              </div>
              <div>
...
function StayAboardBanner() {
  const NIGHT_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/105450714/mn5ePzJGJrovVnJuBnxonq/stay_aboard_hero_v4-Mi5BSeM53h79qFSbDnNe3c.webp";
